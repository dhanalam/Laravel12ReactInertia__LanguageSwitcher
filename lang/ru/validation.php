...
return [
    ...
    */
    ...
    'missing_unless' => 'Поле :attribute должно отсутствовать, когда :other не равно :value.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Указанное значение для :attribute появилось в утечке данных. Пожалуйста, выберите другое значение.',
    ],
    'present' => 'Поле :attribute должно присутствовать.',
    'present_if' => 'Поле :attribute должно присутствовать, когда :other равно :value.',
    'present_unless' => 'Поле :attribute должно присутствовать, когда :other не равно :value.',
